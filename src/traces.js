...
export function initTraces(items, pop) {
  ...
  OBJECTS.forEach((o, i) => {
    ...
    const vid = '/videos/objects/' + o.img.split('/').pop().replace('.png', '.mp4');
